...
export const LOCAL_MIGRATIONS = [
  ...
  {
    id: "009_watch_session_sync_states",
    filename: "009_watch_session_sync_states.sql",
  },
  {
    id: "010_watch_lab_debug_events",
    filename: "010_watch_lab_debug_events.sql",
  },
] as const;
