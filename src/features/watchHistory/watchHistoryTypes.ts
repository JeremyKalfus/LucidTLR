...
export type WatchRuntimeEvent = {
  ...
  eventType:
    ...
    | "epoch_gap_detected"
    | "watch_app_lifecycle_changed"
    | "workout_session_state_changed"
    | "workout_session_failed"
    | "workout_builder_collection_started"
    | "workout_builder_collection_failed"
    | "workout_builder_collection_ended"
    | "workout_builder_discarded"
