...
enum WatchRuntimeEventType: String, Codable, Equatable {
  ...
  case epochGapDetected = "epoch_gap_detected"
  case watchAppLifecycleChanged = "watch_app_lifecycle_changed"
  case workoutSessionStateChanged = "workout_session_state_changed"
  case workoutSessionFailed = "workout_session_failed"
  case workoutBuilderCollectionStarted = "workout_builder_collection_started"
  case workoutBuilderCollectionFailed = "workout_builder_collection_failed"
  case workoutBuilderCollectionEnded = "workout_builder_collection_ended"
  case workoutBuilderDiscarded = "workout_builder_discarded"
